...
class AddView(View):
    ...
    def post(self, request):
        ...
        result = n1 + n2
        return render(request,"add.html",{"addres":result})
...
class MulView(View):
    def get(self, request):
        formm = MathForm()
        return render(request,"mul.html",{"form":formm})
    def post(self,request):
        ...
        result = n1* n2
        return render(request,"mul.html", {"mures":result})
...
class DiviForm(View):
    ...
    def post(self, request):
        ...
        n2 = formm.cleaned_data.get("num2")
        result = n1 / n2
        return render(request,"div1.html",{"div":result})